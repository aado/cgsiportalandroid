...
<div class="container-fluid">
	...
	<div id="transintransout" class="tabcontent">
		<br>
		<ul class="nav nav-tabs">
			<li class="nav-item">
				<a class="nav-link active"  id="nav-toreceive-tab" data-toggle="tab" href="#nav-toreceive" role="tab" aria-controls="nav-toreceive" aria-selected="true">
					TO RECEIVED
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link"  id="nav-transinandout-tab" data-toggle="tab" href="#nav-transinandout" role="tab" aria-controls="nav-transinandout" aria-selected="false">
					TRANS IN AND TRANSOUT
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link"  id="nav-transinandouthistory-tab" data-toggle="tab" href="#nav-transinandouthistory" role="tab" aria-controls="nav-transinandouthistory" aria-selected="false">
					HISTORY
				</a>
			</li>
		</ul>
		<div class="tab-content" id="nav-tabContent">
			<div class="tab-pane fade show active" id="nav-toreceive" role="tabpanel" aria-labelledby="nav-toreceive-tab">
				<br>
				<div class="table-responsive">
					<table id="tobetransmitted" class="table table-striped" style="width:100%;">
						...
						<?php
				 			...
				 			if(isset($toreceived) )
				 			{
				 				foreach ($toreceived as $tr) 
				 				{
				 					
									?>
									<tr>
										<td> <?= $tr['DateReceived'];?> </td>
										<td> <?= $tr['PO_Supplier'];?> </td>
										<td> <?= $tr['ItemQty'];?> </td>
										<td> <?= $tr['ItemUnit'];?> </td>
										<td> <?= $tr['ItemDesc'];?> </td>
										<td> <?= $tr['ItemSize'];?> </td>
										<td> <?= $tr['Deliveryreceipt'];?> </td>
										<td> <?= $tr['PO_Number'];?> </td>
										<td> <?= $tr['Amount'];?> </td>
										<td> <?= $tr['totalamount'];?> </td>
										<td> <?= $tr['Remarks'];?> </td>
										<td>
											<a href="inventorydetails/<?= $tr['ItemDesc'];?>">
												<button type="submit" name="viewdetails" class="btn btn-outline-primary">
													<span id="<?php echo $tr['ID'] ?>">
														<i class="fas fa-th-list" onClick="loadDetail(<?php echo $tr['ID'] ?>)"></i> 
													</span>
												</button>
											</a>
										</td>
			...
			<div class="tab-pane fade" id="nav-transinandout" role="tabpanel" aria-labelledby="nav-transinandout-tab">
				<br>
				<p>
			...
			<!-- HISTORY -->
			<div class="tab-pane fade" id="nav-transinandouthistory" role="tabpanel" aria-labelledby="nav-transinandouthistory-tab">
				<br>
				<div class="table-responsive">
					...
					style="width:100%;">
						...
						if(isset($InventoryHistory) )
							...
							<tr>
								...
								<td> <?= $IH['Note'];?> </td>
								<td> 
									<!-- <form action="attachments_historymis.php" method="POST">
										<input type="hidden" name="Particulars" value="<?php //echo $row['Particulars'];?>" class="form-control">					
										<input type="hidden" name="PO_Number" value="<?php //echo $row['PO_Number'];?>" class="form-control">
										<button type="submit" name="viewimages" class="btn btn-info editbtn">
