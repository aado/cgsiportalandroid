	...
	<div style="margin-top: -20px;">
		<form id="frmPayslip">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<label for="pp" class="col-sm-6 col-form-label">Employee Type</label>
					<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<button type="submit" class="btn btn-primary" id="upload" value="Submit" style="float: right; margin-top: 12px !important; margin-right: 13px"><i class="fa fa-save"></i> Submit</button>
				</div>
			</div>
		</form>
	</div>
